...
.qs-code-block::-webkit-scrollbar-thumb {
...
const QuickStart = () => {
  ...
  const displayKey = createdKey ? `sk-${createdKey}` : 'sk-your-api-key';
  const maskedKey = createdKey
    ? `sk-${createdKey.slice(0, 4)}${'●'.repeat(16)}${createdKey.slice(-4)}`
    : '';
  ...
  const handleCopyCode = () => {
    copy(getTutorialPlainText(tutorialTab, base, displayKey));
    setCodeCopied(true);
    showSuccess(t('已复制'));
        ...
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 48 }} className='qs-step-card'>
            ...
            <h1 className='qs-shimmer-text' style={{
              ...
              fontFamily: 'var(--font-serif)', margin: '0 0 8px',
              lineHeight: 1.2,
            }}>
              {t('快速开始')}
            </h1>
              ...
              <React.Fragment key={s.step}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                  ...
                  {!isMobile && (
                    <Text style={{
                      ...
                      color: activeStep === s.step ? 'var(--accent)' : 'var(--text-muted)',
                ...
                {i < steps.length - 1 && (
                  <div style={{
                    ...
                    background: completedSteps.has(s.step)
                      ? 'var(--success)' : 'var(--border-default)',
                    borderRadius: 1,
                ...
                {completedSteps.has(1) ? (
                  <div className='qs-content-enter' style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    <div style={{
                      ...
                      <div>
                        <Text strong style={{ color: 'var(--success)', display: 'block' }}>
                          {t('API Key 已创建')}
                        </Text>
                    ...
                    <div style={{
                      ...
                      <Button
                        icon={keyRevealed ? <IconEyeClosed /> : <IconEyeOpened />}
                        theme='borderless' type='tertiary' size='small'
                        onClick={() => setKeyRevealed(!keyRevealed)}
                      />
                      <Button
                        icon={keyCopied ? <IconTick /> : <IconCopy />}
                        theme='borderless' type='tertiary' size='small'
                  ...
                  <div className='qs-content-enter' style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <Banner
                      type='info'
                      description={t('将创建一个无限额度、永不过期的 API Key，你可以稍后在令牌页面修改配置。')}
                      style={{ borderRadius: 'var(--radius-md)' }}
                      closeIcon={null}
                    />
                    <Button
              ...
              >
                <div className='qs-content-enter' style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    {[
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: tutorialTab === item.key
                            ? '1px solid var(--accent)' : '1px solid var(--border-default)',
                          background: tutorialTab === item.key
                            ? 'var(--accent-light)' : 'var(--surface)',
                          color: tutorialTab === item.key
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <div className='qs-code-block' style={{
...
const StepCard = ({ step, icon, title, subtitle, active, completed, onToggle, children, t }) => {
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            {completed && (
              <Tag size='small' color='green' style={{ borderRadius: 'var(--radius-sm)' }}>
                {t('已完成')}
              </Tag>
            )}
          </div>
