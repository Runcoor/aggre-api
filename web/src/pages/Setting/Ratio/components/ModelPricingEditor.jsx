...
const PriceInput = ({
  ...
  <div style={{ marginBottom: 16 }}>
    <div className='mb-1 font-medium text-mv-text-secondary flex items-center justify-between gap-3'>
      <span>{label}</span>
      {headerAction}
    </div>
    {!hidden ? (
    ...
    {extraText ? (
      <div className='mt-1 text-xs text-mv-text-muted'>{extraText}</div>
    ) : null}
  </div>
);
  ...
  return (
    <>
      <Space vertical align='start' style={{ width: '100%' }}>
        ...
        {listDescription ? (
          <div className='text-sm text-mv-text-muted'>{listDescription}</div>
        ) : null}
        ...
        >
          ...
          >
            {!selectedModel ? (
              ...
              <div>
                <div className='mb-4'>
                  <div className='mb-2 font-medium text-mv-text-secondary'>
                    {t('计费方式')}
                  </div>
                  <RadioGroup
                    type='button'
                  ...
                  <div className='mt-2 text-xs text-mv-text-muted'>
                    {t(
                ...
                {selectedWarnings.length > 0 ? (
                  ...
                  >
                    ...
                    {selectedWarnings.map((warning) => (
                      <div key={warning} className='text-sm text-mv-text-secondary mb-1'>
                        {warning}
                      </div>
                    ))}
                  </Card>
                ...
                >
                  ...
                  <div className='text-xs text-mv-text-muted mb-3'>
                    {t(
      ...
      >
        ...
        {selectedModel ? (
          <div className='text-xs text-mv-text-muted mt-3'>
            {t(
