...
LogoLoop — adapted from React Bits (reactbits.dev). Horizontal/vertical
infinite logo carousel. RAF-driven for smooth speed transitions on
hover, dynamic copy-count for seamless looping at any container width.
*/
